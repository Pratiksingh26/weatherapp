    ...
    <div>
      <div className="searchbar">
        ...
        <button className="searchIcon" onClick={sendCity}>
          <SearchOutlinedIcon fontSize="medium" style={{marginRight:"150px"}}/>
        </button>
      </div>
      <div style={{backgroundColor:"white"}} id="detail">
        {days.map((e) => (
          <div
            id="detailInsideDiv"
            key={e.id}
      ...
      <div className="tempChart" style={{backgroundColor:"white"}}>
      ...
      <div className="mapdiv" style={{backgroundColor:"white"}}>
        <iframe
          title="gmap"
          name="gMap"
          className="map"
